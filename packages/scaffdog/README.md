...
| `head`     | `[value: string, n: string \| number, offset?: number]` | Cut out the beginning of the string. If `n` is a number, the target is the specified line; if it is a string, the target is the first matching line. |
